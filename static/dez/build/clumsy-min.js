var game = {
    ...
    resources: [{
        name: "bg",
        type: "image",
        src: "/dez/data/img/bg.png"
    }, {
        name: "clumsy",
        type: "image",
        src: "/dez/data/img/clumsy.png"
    }, {
        name: "pipe",
        type: "image",
        src: "/dez/data/img/pipe.png"
    }, {
        name: "logo",
        type: "image",
        src: "/dez/data/img/logo.png"
    }, {
        name: "ground",
        type: "image",
        src: "/dez/data/img/ground.png"
    }, {
        name: "gameover",
        type: "image",
        src: "/dez/data/img/gameover.png"
    }, {
        name: "gameoverbg",
        type: "image",
        src: "/dez/data/img/gameoverbg.png"
    }, {
        name: "hit",
        type: "image",
        src: "/dez/data/img/hit.png"
    }, {
        name: "getready",
        type: "image",
        src: "/dez/data/img/getready.png"
    }, {
        name: "new",
        type: "image",
        src: "/dez/data/img/new.png"
    }, {
        name: "share",
        type: "image",
        src: "/dez/data/img/share.png"
    }, {
        name: "tweet",
        type: "image",
        src: "/dez/data/img/tweet.png"
    }, {
        name: "theme",
        type: "audio",
        src: "/dez/data/bgm/"
...
game.BirdEntity = me.Entity.extend({
    ...
    init: function(a, b) {
        this._super(me.Renderable, "init", [a, b, 10, 10]), this.stepsFont = new me.Font("gamefont", 80, "#ABB36E", "center"), this.floating = !0
    },
    draw: function(a) {
...
game.TitleScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        this.dialog = new(me.Renderable.extend({
            init: function() {
                this._super(me.Renderable, "init", [0, 0, me.game.viewport.width / 2, me.game.viewport.height / 2]), this.font = new me.Font("gamefont", 40, "#E1E5BB", "left"), this.steps = "Steps: " + game.data.steps.toString(), this.topSteps = "Higher Step: " + me.save.topSteps.toString()
            },
            draw: function(a) {
