...
<div class="main-content">
    <div>
        ...
        />
        <p>
            ZED RUN is a groundbreaking horse racing game built on the blockchain. Race your digital racehorses against
            other competitors, win exciting prizes, and experience the thrill of horse racing like never before. As a
            player, you can breed, buy, and race your very own racehorses, each with unique attributes and performance
            capabilities. The game is powered by smart contracts, ensuring fairness and transparency for all players.
        </p>
    </div>
    <ProjectDetails
